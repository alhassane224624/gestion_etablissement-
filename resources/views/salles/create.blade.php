...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-12">
            <h2><i class="fas fa-door-open"></i> Créer une Salle</h2>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="capacite" id="capacite" class="form-control @error('capacite') is-invalid @enderror" value="{{ old('capacite') }}" min="1" max="1000" required>
                            @error('capacite')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="batiment" id="batiment" class="form-control @error('batiment') is-invalid @enderror" value="{{ old('batiment') }}">
                            @error('batiment')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="etage" id="etage" class="form-control @error('etage') is-invalid @enderror" value="{{ old('etage') }}">
                            @error('etage')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="disponible" name="disponible" value="1" {{ old('disponible', true) ? 'checked' : '' }}>
                        ...
                        <div class="border p-3" style="max-height: 300px; overflow-y: auto;">
                            @foreach($equipements as $value => $label)
                                <div class="custom-control custom-checkbox mb-2">
                                    <input type="checkbox" class="custom-control-input" id="eq_{{ $value }}" name="equipements[]" value="{{ $value }}" {{ in_array($value, old('equipements', [])) ? 'checked' : '' }}>
