...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-12">
            <h2><i class="fas fa-calendar-plus"></i> Ajouter un Cours au Planning</h2>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="date" id="date" class="form-control @error('date') is-invalid @enderror" value="{{ old('date', $date ?? '') }}" required>
                            @error('date')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" name="heure_debut" id="heure_debut" class="form-control @error('heure_debut') is-invalid @enderror" value="{{ old('heure_debut', $heure ?? '08:00') }}" required>
                                    @error('heure_debut')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" name="heure_fin" id="heure_fin" class="form-control @error('heure_fin') is-invalid @enderror" value="{{ old('heure_fin', '10:00') }}" required>
                                    @error('heure_fin')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="type_cours" id="type_cours" class="form-control @error('type_cours') is-invalid @enderror" required>
                                ...
                                <option value="td" {{ old('type_cours') == 'td' ? 'selected' : '' }}>Travaux dirigés</option>
                                <option value="tp" {{ old('type_cours') == 'tp' ? 'selected' : '' }}>Travaux pratiques</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Note:</strong> Le système vérifiera automatiquement les conflits avant d'enregistrer le cours.
                        </div>
                    </div>
                </div>
...
<script>
// Vérifier la disponibilité de la salle en temps réel
